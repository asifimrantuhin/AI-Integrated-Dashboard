...
@section('title', 'HR Data Upload')
@section('page-title', 'HR Data Upload Management')

@section('content')
<div class="d-flex justify-content-between align-items-center mb-4">
    <h3>HR Data Uploads</h3>
    <a href="{{ route('admin.upload.hr.create') }}" class="btn btn-primary">
            ...
            <tbody>
                @forelse($uploads as $upload)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.upload.hr.show', $upload->id) }}" class="btn btn-sm btn-info">
