...
@section('title', 'Supply Chain Upload Details')
@section('page-title', 'Supply Chain Upload Details')
...
<div class="row">
    <div class="col-12">
        ...
        <div class="mt-3">
            <a href="{{ route('admin.upload.supplychain.index') }}" class="btn btn-secondary">
