...
@section('title', 'Finance Data Upload')
@section('page-title', 'Finance Data Upload Management')

@section('content')
<div class="d-flex justify-content-between align-items-center mb-4">
    <h3>Finance Data Uploads</h3>
    <a href="{{ route('admin.upload.finance.create') }}" class="btn btn-primary">
            ...
            <tbody>
                @forelse($uploads as $upload)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.upload.finance.show', $upload->id) }}" class="btn btn-sm btn-info">
