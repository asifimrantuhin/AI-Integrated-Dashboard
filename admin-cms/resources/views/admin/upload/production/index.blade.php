...
@section('title', 'Production Data Upload')
@section('page-title', 'Production Data Upload Management')

@section('content')
<div class="d-flex justify-content-between align-items-center mb-4">
    <h3>Production Data Uploads</h3>
    <a href="{{ route('admin.upload.production.create') }}" class="btn btn-primary">
            ...
            <tbody>
                @forelse($uploads as $upload)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.upload.production.show', $upload->id) }}" class="btn btn-sm btn-info">
