...
@section('title', 'Inventory Data Upload')
@section('page-title', 'Inventory Data Upload Management')

@section('content')
<div class="d-flex justify-content-between align-items-center mb-4">
    <h3>Inventory Data Uploads</h3>
    <a href="{{ route('admin.upload.inventory.create') }}" class="btn btn-primary">
            ...
            <tbody>
                @forelse($uploads as $upload)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.upload.inventory.show', $upload->id) }}" class="btn btn-sm btn-info">
