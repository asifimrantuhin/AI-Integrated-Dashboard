...
@section('title', 'Sales Upload Details')
@section('page-title', 'Sales Upload Details')
...
<div class="row">
    <div class="col-12">
        ...
        @if($upload->status == 'completed' && count($data) > 0)
            <div class="card">
                <div class="card-header">
                    <h4>Uploaded Data Preview (First 100 rows)</h4>
                </div>
                <div class="card-body">
        ...
        <div class="mt-3">
            <a href="{{ route('admin.upload.sales.index') }}" class="btn btn-secondary">
