...
@section('title', 'NPD Data Upload')
@section('page-title', 'NPD Data Upload Management')

@section('content')
<div class="d-flex justify-content-between align-items-center mb-4">
    <h3>NPD Data Uploads</h3>
    <a href="{{ route('admin.upload.npd.create') }}" class="btn btn-primary">
            ...
            <tbody>
                @forelse($uploads as $upload)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.upload.npd.show', $upload->id) }}" class="btn btn-sm btn-info">
